...
import 'package:sunset_widget/views/scoreboard_page.dart';

import 'football_game_live_activity.dart';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    _liveActivitiesPlugin.init(
      appGroupId: 'group.sunset11.liveactivity',
      urlScheme: "sus"
    );
    ...
    active: (activity) {
      // Get the token
       print('Activity Token: ${activity.activityToken}');
    },
    ended: (activity) {},
    unknown: (activity) {},
    stale: (value) {
